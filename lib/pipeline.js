...
/**
 * Shared orchestrator submit: file the work item, nudge the mayor to dispatch
 * it now, track it to a merge, then post the intent trail host-side (pogod reaps the
